...
\begin{itemize}
\item Welcome to Mixtape Sessions, Causal Inference 2 -- a workshop on difference-in-differences!
...
\begin{itemize}
\item \url{https://github.com/Mixtape-Sessions/Causal-Inference-2/}
...
\begin{frame}{Will You Be Able to Spot the Problem by the End of the Workshop?}
