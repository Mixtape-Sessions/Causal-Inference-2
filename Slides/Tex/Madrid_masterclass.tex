...
\item Goodman-Bacon focused on decomposition of TWFE to show bias under differential timing, but only for a single parameter (``static'')
\item Callaway and Sant'anna presented alternative estimator that yields unbiased estimates of group-time ATTs which can be aggregated or put into event study plots
