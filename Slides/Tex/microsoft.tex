...
\item Sorting into treatment based on potential outcomes always implies selection bias
	\begin{enumerate}
	\item I chose to get a PhD because I thought I would be less happy without it -- i.e., selection on $Y^0$ 
	\item I chose to get a PhD because I thought it would make me happier -- i.e., selection on $Y^1$ 
	\item I chose to get a PhD because treatment effects were positive -- i.e., selection on treatment gains, $\delta = Y^1-Y^0$
	\end{enumerate}
\item More rational, more efficient, our decision making processes are, the \emph{worse} the bias gets without research designed to address it
\end{itemize}
