...
\begin{frame}{Welcome!}
  ...
  \begin{itemize}
	...
	\item Deep dive into the potential outcomes framework 
...
\item Aristotle was different than Hume, Mill, and Lewis -- I am not comfortable saying to Aristotle he was wrong
\item What I can do is explain the potential outcomes framework of causal inference and use it to discuss methods and tools that estimate parameters consistent with that view
...
\begin{frame}{Naive causal inference}
  ...
  \begin{itemize}
    ...
    \item They conclude doctors are killing patients with ventilators so they come to earth, and try to liberate the patients, but it only makes things worse
...
\item \textbf{No One Causal Effect}: There is no such thing as``the causal effect''; there's many and your first step is to pick one
\end{enumerate}
...
\begin{frame}{Counterfactuals Nearly Killed Causal Inference}
...
\item Sorting into treatment based on potential outcomes always implies selection bias
	\begin{enumerate}
	...
	\item I chose to get a PhD because treatment effects were positive -- $\delta = Y^1-Y^0$
	\end{enumerate}
\item More rational, more efficient, our decision making processes, the \emph{worse} the bias gets!
\end{itemize}
...
\begin{itemize}
\item Patients come to the Perfect Doctor who knows each person's treatment effects and assigns treatment based on it
...
\begin{frame}{In Defense of the ATT}
...
\begin{frame}{Curse of Dimensionality}
	...
	\item Common support problems isn't about the covariates -- you probably will find white people in treatment and control, women in both groups, college educated in both groups
	\item Common support is about white women with a college degree in both groups -- it's about the dimensions which is why the curse grows fast
	\end{itemize}
\end{frame}
