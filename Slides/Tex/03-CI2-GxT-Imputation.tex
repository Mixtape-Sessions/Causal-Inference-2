...
\begin{itemize}
\item False dichotomy -- all of causal inference is imputation of counterfactuals
\item But some are more explicit about than others and the BJA model is more explicit than CS/SA/DCDH
\item Imputation are regression based modeling of missing counterfactuals, can improve on power with more pre-treatment data, and handle covariates without common support
\item But losing common support is not a strength of any design as this will impose strong assumptions on the covariates, plus strong functional form restrictions
\end{itemize}
