...
\item Combining lecture, discussion and simulations
...
\begin{itemize}
\item Problem unstated: the treatment parameter was assumed to be constant
\item Strict exogeneity implied this, and only most sophisticated instructors (i.e., not me) seemed to know and teach this
\item Gardner (2021) notes that fixed effects are correlated with error term under differential timing which is why it breaks down
\end{itemize}
