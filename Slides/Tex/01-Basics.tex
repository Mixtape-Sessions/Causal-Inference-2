...
\begin{frame}{Potential outcomes differ from realized data}

\begin{itemize}
\item Potential outcomes are \emph{a priori} real but as they have not yet happened, they are not known
...
Let's do this together now. It'll help to see it with your own eyes.
