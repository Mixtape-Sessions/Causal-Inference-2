...
\item Remember from earlier: some forms of selection that satisfy parallel trends will complicate event study plots
...
\begin{figure}
    \centering
    \includegraphics[height=0.70\textheight]{./lecture_includes/selection_fe.png}
\end{figure}
