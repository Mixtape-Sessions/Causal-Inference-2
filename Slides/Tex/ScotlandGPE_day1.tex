...
\begin{itemize}
\item Welcome to Scotland's Graduate Programme in Economics Summer School on difference-in-differences!  
\item Scott Cunningham, Professor at Baylor, Waco Texas (halfway between Dallas and Austin) 
Thank you for welcoming me to Scotland!
\end{itemize}

\end{frame}


\begin{frame}{One massively important detail about me}

Just so you understand, I'm a 47 year-old man who saw Braveheart as a sophomore in college at a formative time in my life before my prefrontal cortex had fully formed

\bigskip

As such, I am neither willing nor capable to entertain any thoughts or comments that the movie is not 100\% historically accurate

\bigskip

My theory is the movie is accurate just as in the movie Scots heard rumors he was a giant, I believe we've heard rumors that he wasn't real, and I choose to believe in legends and myths, so thank you for having me in this amazing place


\end{frame}

\begin{frame}{Promises I Can Keep}

But out of the deepest respect for the economics of humor (diminishing returns to the same joke and collection action problems) as well as to create a safe space, I can make the following promises:


	\begin{enumerate}
	\item I promise not to quote any lines from Braveheart while I'm \textbf{with any of you}
	\item I promise not to have any pictures of Mel Gibson as William Wallace with battle paint on his face in my slides
	\item And even if baited by someone in the audience to acknowledge Braveheart, I promise not to understand the reference nor smile nor laugh
	\end{enumerate}
	
\bigskip

If I break these promises, I will pay donate one euro for every violation to the Daughters of William Wallace and Liberty (I'll google if that's real later)
...
With some exception (e.g., Heckman, Ichimura and Todd 1997; Abadie 2005; Bertrand, Duflo and Mullainthan 2004), econometricians had not given it much notice. Let's review now the few papers that had covered by econometricians as well as a new one
...
\subsection{Outcome Regression Double Robust}
